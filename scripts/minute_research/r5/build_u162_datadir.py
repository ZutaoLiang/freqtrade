...
OUT = "user_data/data/r5u162/futures"; os.makedirs(OUT, exist_ok=True)
D = np.load("user_data/minute_research/r5/p7_panel_union.npz", allow_pickle=True)
...
import json
KEEP = set(json.load(open("user_data/minute_research/r5/u162_theirs.json")))
