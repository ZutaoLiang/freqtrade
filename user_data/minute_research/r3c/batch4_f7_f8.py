...
def run_batch4():
    ...
    seg = os.environ.get("RUN_SEG", "TRAIN")
    out_csv = "/root/freqtrade/user_data/minute_research/r3c/batch4_results.csv" if seg == "TRAIN" else f"/root/freqtrade/user_data/minute_research/r3c/batch4_valid_results.csv"
