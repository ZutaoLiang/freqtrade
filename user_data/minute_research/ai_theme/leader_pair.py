...
import ai_theme as PT

SEG = PT.SEG


def load():
    D = {b: PT.bars(b, "1D") for b in PT.P + ["BTC"]}; idx = D["WLD"].index
...
if __name__ == "__main__":
    ...
    if "--filters" in sys.argv:
        ...
        TF = None
    for n, leader, filt in itertools.product((20, 50), ("WLD", "mom7", "mom28"), filters):
        offs = [0] if leader == "WLD" else range(7)
