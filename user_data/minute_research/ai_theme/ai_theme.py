"""AI-theme copy of privacy_theme.py (same rules; theme list and leader replaced before any run). Original:
...
P = ["WLD", "TAO", "FET", "RENDER", "ARKM", "GRASS", "IO", "VANA", "VIRTUAL", "AI16Z", "AIXBT", "GOAT", "ARC", "GRIFFAIN", "ALCH", "ACT", "SWARMS", "COOKIE", "ZEREBRO", "AVAAI"]  # AI theme, pre-registered; leader = WLD (highest TRAIN liquidity)
...
def direction1(segs):
    H = {b: bars(b, "1h") for b in P}; idx = H["WLD"].index
...
def direction2(segs):
    D = {b: bars(b, "1D") for b in P}; idx = D["WLD"].index
