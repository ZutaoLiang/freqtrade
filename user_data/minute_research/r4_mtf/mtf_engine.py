"""Vectorized MTF Research Engine (r4_mtf).
...
- Fast JIT simulation with SL, TP, time-stop, and realistic taker fees.
- Daily clustered t-statistic, Profit Factor (PF), Sharpe, Win Rate, Max Drawdown.
"""
import os
import json
