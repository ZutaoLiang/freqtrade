...
def run_batch3():
    ...
    seg = os.environ.get("RUN_SEG", "TRAIN")
    out_csv = "/root/freqtrade/user_data/minute_research/r3/batch3_results.csv" if seg == "TRAIN" else f"/root/freqtrade/user_data/minute_research/r3/batch3_valid_results.csv"
