...
def run_batch5():
    ...
    seg = os.environ.get("RUN_SEG", "TRAIN")
    out_csv = "/root/freqtrade/user_data/minute_research/r3/batch5_results.csv" if seg == "TRAIN" else f"/root/freqtrade/user_data/minute_research/r3/batch5_valid_results.csv"
