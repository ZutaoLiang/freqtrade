...
def run():
    ...
    seg = os.environ.get("RUN_SEG", "TRAIN")
    out_csv = "/root/freqtrade/user_data/minute_research/r3/exp500_batch3_results.csv" if seg == "TRAIN" else f"/root/freqtrade/user_data/minute_research/r3/exp500_batch3_valid_results.csv"
