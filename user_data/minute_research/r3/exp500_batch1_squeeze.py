...
def run():
    ...
    seg = os.environ.get("RUN_SEG", "TRAIN")
    out_csv = "/root/freqtrade/user_data/minute_research/r3/exp500_batch1_results.csv" if seg == "TRAIN" else f"/root/freqtrade/user_data/minute_research/r3/exp500_batch1_valid_results.csv"
