...
class StakePositionManager(IStrategy):
    ...
    def custom_stoploss(self, pair: str, trade: Trade, current_time: datetime,
        ...
        recent_volatility = dataframe['atr_pct'].iloc[-3:].mean()
        dynamic_roi_pct = self.base_stoploss_pct * 0.6 * (1 + 30 * recent_volatility / 100)
...
class GridV3Strategy(StakePositionManager):
