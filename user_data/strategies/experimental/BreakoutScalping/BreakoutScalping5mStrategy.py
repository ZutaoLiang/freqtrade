...
class BreakoutScalping5mStrategy(IStrategy):
    ...
    def custom_stoploss(self, pair: str, trade: Trade, current_time: datetime,
        ...
        if current_profit > 0.3 * self.trade_leverage:
            return 0.2 * self.trade_leverage
        ...
        # elif current_profit > 0.06 * self.trade_leverage:
            ...
            return stoploss_from_open(0.05 * self.trade_leverage * 0.5, current_profit, is_short=trade.is_short, leverage=trade.leverage)
