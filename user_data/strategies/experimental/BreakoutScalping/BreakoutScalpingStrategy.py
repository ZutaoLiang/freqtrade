...
class BreakoutScalpingStrategy(IStrategy):
    ...
    breakout_long_length = 30
    breakout_short_length = breakout_long_length
    
    large_up_ratio = 1.0003
    ...
    def custom_stoploss(self, pair: str, trade: Trade, current_time: datetime,
        ...
        if current_profit > 0.2 * self.trade_leverage:
            return 0.12 * self.trade_leverage
        elif current_profit > 0.1 * self.trade_leverage:
            return 0.06 * self.trade_leverage
        elif current_profit > 0.06 * self.trade_leverage:
            return 0.025 * self.trade_leverage
        ...
        elif current_profit > 0.03 * self.trade_leverage:
            return stoploss_from_open(0.03 * self.trade_leverage * 0.5, current_profit, is_short=trade.is_short, leverage=trade.leverage)
