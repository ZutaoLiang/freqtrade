...
class ZLSMA_EMA(IStrategy):
    ...
    #     smoothed_data = savgol_filter(data, self.smooth_length, 1, mode='nearest')
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe['smoothed_ma'] = pta.ema(dataframe['zlsma'], length=self.smooth_length)
        ...
        dataframe['lower'] = dataframe['zlsma'] - self.atr_multiplier * dataframe['atr']
        dataframe['upper'] = dataframe['zlsma'] + self.atr_multiplier * dataframe['atr']
