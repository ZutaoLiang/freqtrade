...
class VolumeTrendTrailingV1(IStrategy):
    timeframe = '5m'
    ...
    def custom_exit(
        ...
        **kwargs,
        ...
        last_candle = dataframe.iloc[-1].squeeze()
        if (last_candle['exit_long_trend'] == 1 or last_candle['exit_short_trend'] == 1) and max_profit > 0 and _current_profit > 0.6 * max_profit:
            return 'exit_trend'
        ...
        if max_profit > 0.06 and 0.4 * max_profit < _current_profit < 0.6 * max_profit:
            return "06_drawdown"
        
        if max_profit > 0.03 and 0.3 * max_profit < _current_profit < 0.5 * max_profit:
            return "03_drawdown"
