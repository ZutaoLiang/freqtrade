...
class VolumeTrendTrailingV2(IStrategy):
    timeframe = '15m'
    ...
    def custom_exit(
        ...
        **kwargs,
        ...
        last_candle = dataframe.iloc[-1].squeeze()
        if (last_candle['exit_long_trend'] == 1 or last_candle['exit_short_trend'] == 1) and max_profit > 0.005 and _current_profit > 0.6 * max_profit:
            return 'exit_trend'
