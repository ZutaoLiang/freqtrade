...
class Trend5mV9(IStrategy):
    ...
    def custom_exit(
        ...
        **kwargs,
        ...
        if open_hours > 6:
            if max_profit > 0.05:
                if 0 < current_profit < 0.6 * max_profit:
                    return "longtime_low_profit_60"
            else:
                if 0 < current_profit < 0.5 * max_profit:
                    return "longtime_low_profit_50"
