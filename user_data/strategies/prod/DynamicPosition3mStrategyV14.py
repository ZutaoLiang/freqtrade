...
class DynamicPosition3mStrategyV14(IStrategy):
    ...
    initial_position_ratio = 2/trade_leverage
    ...
    def custom_exit(self, pair: str, trade: Trade, current_time: datetime,
        ...
        if count_of_entries <= 3 and (0.005 * leverage) < current_profit and current_profit < (0.02 * leverage) and (current_time - timedelta(minutes=30)) > trade.open_date_utc:
            return 'Low profit'
        
        if (0.001 * leverage) < current_profit and current_profit < (0.01 * leverage) and (current_time - timedelta(hours=2)) > trade.open_date_utc:
