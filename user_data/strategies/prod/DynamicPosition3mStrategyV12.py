...
class TotalProfitDrawdownExit:
    def __init__(self, leverage):
        ...
        self.PAIR_DRAWDOWN_THRESHOLD = 0.06
...
class DynamicPosition3mStrategyV12(IStrategy):
    ...
    def custom_exit(self, pair: str, trade: Trade, current_time: datetime,
        ...
        if count_of_entries <= 3 and (0.01 * leverage) < current_profit and current_profit < (0.02 * leverage) and (current_time - timedelta(minutes=30)) > trade.open_date_utc:
        ...
        profit_drawdown_threshold = -2.5 * (total * leverage * self.initial_position_ratio * self.absolute_drawdown_profit_ratio) / self.max_open_trades
        ...
        if self.is_long:
            ...
            dataframe.loc[
                (
                    ...
                    (dataframe['ha_close'] > self.long_up_ratio * dataframe['ema_mid']) &
