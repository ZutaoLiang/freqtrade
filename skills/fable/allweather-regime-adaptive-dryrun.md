...
> ⚠️ **独立复核（2026-09-25，另一会话，详见 `.claude/skills/binance-minute-strategy-research/PROFITABLE_STRATEGIES.md` 第十一节）**：
> 在独立构建的数据上原样回测，VALID+HOLDOUT 整体按日聚类 t 1.69（费率 0.10% 时 1.46），未过 §4 的 t ≥ 2；收益几乎全部来自 R24 分支
> （V+HO t 3.98），双挤压做多 t 0.42，暴跌抄底样本外为负；剔除 ARC 后整体 t 0.62。下文 "全周期 5.39 倍" 含隔离期 2025-10..11 与杠杆复利，
> 不是样本外证据。本手册仅作 dry-run 观察用途，不要据此投入真实资金。
